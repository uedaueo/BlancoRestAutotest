...
public class BlancoRestAutotestMessage {
    ...
    /**
     * メッセージ定義ID[BlancoRestAutotest]、キー[MBVOJI01]の文字列を取得します。
     *
     * No.2:
    ...
    /**
     * メッセージ定義ID[BlancoRestAutotest]、キー[MBVOJI02]の文字列を取得します。
     *
     * No.3:
    ...
    /**
     * メッセージ定義ID[BlancoRestAutotest]、キー[MBVOJI03]の文字列を取得します。
     *
     * No.4:
    ...
    /**
     * メッセージ定義ID[BlancoRestAutotest]、キー[MBVOJI04]の文字列を取得します。
     *
     * No.5:
    ...
    /**
     * メッセージ定義ID[BlancoRestAutotest]、キー[MBVOJI05]の文字列を取得します。
     *
     * No.6:
    ...
    /**
     * メッセージ定義ID[BlancoRestAutotest]、キー[MBVOJI06]の文字列を取得します。
     *
     * No.7:
    ...
    /**
     * メッセージ定義ID[BlancoRestAutotest]、キー[MBVOJI07]の文字列を取得します。
     *
     * No.8:
     * 文字列[クラス名[{0}] フィールド[{1}] では null は許容しません。]
     *
     * @param arg0 置換文字列{0}の値。
     * @param arg1 置換文字列{1}の値。
     * @return メッセージ文字列。
    ...
    public String getMbvoji07(final String arg0, final String arg1) {
        ...
        if (arg1 == null) {
            throw new IllegalArgumentException("メソッド[getMbvoji07]のパラメータ[arg1]にnullが与えられました。しかし、このパラメータにnullを与えることはできません。");
        }
    ...
    /**
     * メッセージ定義ID[BlancoRestAutotest]、キー[MBVOJI08]の文字列を取得します。
     *
     * No.9:
     * 文字列[入出力[{0}] で、親プロパティが継続なのに左隣にプロパティが定義されていません。]
     *
     * @param arg0 置換文字列{0}の値。
     * @return メッセージ文字列。
     */
    ...
    /**
     * メッセージ定義ID[BlancoRestAutotest]、キー[MBVOJI09]の文字列を取得します。
     *
     * No.10:
     * 文字列[入出力[{0}] で、型[{1}]が定義されていますがそれは存在しません。]
     *
     * @param arg0 置換文字列{0}の値。
     * @param arg1 置換文字列{1}の値。
     * @return メッセージ文字列。
    ...
    public String getMbvoji09(final String arg0, final String arg1) {
        ...
        if (arg1 == null) {
            throw new IllegalArgumentException("メソッド[getMbvoji09]のパラメータ[arg1]にnullが与えられました。しかし、このパラメータにnullを与えることはできません。");
        }
