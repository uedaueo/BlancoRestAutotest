...
/**
 * Process [BlancoRestAutotestProcess] interface.
 *
 * Inherit this interface and create a [BlancoRestAutotestProcessclass in the [blanco.restautotest.task] package to implement the actual batch processing.<br>
 */
