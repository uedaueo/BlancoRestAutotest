package blanco.restautotest.resourcebundle;
...
/**
 * BlancoRestAutotestが利用するリソースバンドルを蓄えます。
 *
 * リソースバンドル定義: [BlancoRestAutotest]。<BR>
 ...
 * </UL>
 */
public class BlancoRestAutotestResourceBundle {
    /**
     * リソースバンドルオブジェクト。
     *
    ...
    /**
     * BlancoRestAutotestResourceBundleクラスのコンストラクタ。
     *
     * 基底名[BlancoRestAutotest]、デフォルトのロケール、呼び出し側のクラスローダを使用して、リソースバンドルを取得します。
     */
    public BlancoRestAutotestResourceBundle() {
        try {
            fResourceBundle = ResourceBundle.getBundle("blanco/restautotest/resourcebundle/BlancoRestAutotest");
     ...
     * BlancoRestAutotestResourceBundleクラスのコンストラクタ。
     *
     * 基底名[BlancoRestAutotest]、指定されたロケール、呼び出し側のクラスローダを使用して、リソースバンドルを取得します。
     *
     * @param locale ロケールの指定
     */
    public BlancoRestAutotestResourceBundle(final Locale locale) {
        try {
            fResourceBundle = ResourceBundle.getBundle("blanco/restautotest/resourcebundle/BlancoRestAutotest", locale);
        } catch (MissingResourceException ex) {
        }
    }
     ...
     * BlancoRestAutotestResourceBundleクラスのコンストラクタ。
     *
     * 基底名[BlancoRestAutotest]、指定されたロケール、指定されたクラスローダを使用して、リソースバンドルを取得します。
     *
     * @param locale ロケールの指定
     * @param loader クラスローダの指定
     */
    public BlancoRestAutotestResourceBundle(final Locale locale, final ClassLoader loader) {
        try {
            fResourceBundle = ResourceBundle.getBundle("blanco/restautotest/resourcebundle/BlancoRestAutotest", locale, loader);
        } catch (MissingResourceException ex) {
        }
    }
    ...
    /**
     * bundle[BlancoRestAutotest], key[METAFILE_DISPLAYNAME]
     *
    ...
    /**
     * bundle[BlancoRestAutotest], key[META2XML.ELEMENT_COMMON]
     *
    ...
    /**
     * bundle[BlancoRestAutotest], key[META2XML.ELEMENT_LIST]
     *
    ...
    /**
     * bundle[BlancoRestAutotest], key[META2XML.ELEMENT_EXTENDS]
     *
    ...
    /**
     * bundle[BlancoRestAutotest], key[META2XML.ELEMENT_IMPLEMENTS]
     *
    ...
    /**
     * bundle[BlancoRestAutotest], key[XML2JAVACLASS.FIELD.NAME]
     *
     * [フィールド: [{0}]。] (ja)<br>
     *
    ...
    /**
     * bundle[BlancoRestAutotest], key[XML2JAVACLASS.FIELD.DEFAULT]
     *
     * [デフォルト: [{0}]。] (ja)<br>
     *
     * @param arg0 置換文字列{0}を置換する値。java.lang.String型を与えてください。
    ...
    /**
     * bundle[BlancoRestAutotest], key[XML2JAVACLASS.SET.JAVADOC.01]
     *
    ...
    /**
     * bundle[BlancoRestAutotest], key[XML2JAVACLASS.SET.JAVADOC.02]
     *
     * [フィールドの説明: [{0}]。] (ja)<br>
     *
     * @param arg0 置換文字列{0}を置換する値。java.lang.String型を与えてください。
    ...
    /**
     * bundle[BlancoRestAutotest], key[XML2JAVACLASS.SET.ARG.JAVADOC]
     *
    ...
    /**
     * bundle[BlancoRestAutotest], key[XML2JAVACLASS.GET.JAVADOC.01]
     *
    ...
    /**
     * bundle[BlancoRestAutotest], key[XML2JAVACLASS.GET.JAVADOC.02]
     *
     * [フィールドの説明: [{0}]。] (ja)<br>
     *
     * @param arg0 置換文字列{0}を置換する値。java.lang.String型を与えてください。
    ...
    /**
     * bundle[BlancoRestAutotest], key[XML2JAVACLASS.GET.DEFAULT.JAVADOC]
     *
     * [デフォルト: [{0}]。] (ja)<br>
     *
     * @param arg0 置換文字列{0}を置換する値。java.lang.String型を与えてください。
    ...
    /**
     * bundle[BlancoRestAutotest], key[XML2JAVACLASS.GET.RETURN.JAVADOC]
     *
    ...
    /**
     * bundle[BlancoRestAutotest], key[XML2SOURCE_FILE.ERR001]
     *
    ...
    /**
     * bundle[BlancoRestAutotest], key[XML2SOURCE_FILE.ERR002]
     *
    ...
    /**
     * bundle[BlancoRestAutotest], key[XML2SOURCE_FILE.ERR003]
     *
    ...
    /**
     * bundle[BlancoRestAutotest], key[XML2SOURCE_FILE.ERR004]
     *
    ...
    /**
     * bundle[BlancoRestAutotest], key[XML2SOURCE_FILE.ERR005]
     *
    ...
    /**
     * bundle[BlancoRestAutotest], key[XML2SOURCE_FILE.ERR006]
     *
    ...
    /**
     * bundle[BlancoRestAutotest], key[XML2SOURCE_FILE.FIELD.NAME]
     *
     * [フィールド [{0}]] (ja)<br>
     *
     * @param arg0 置換文字列{0}を置換する値。java.lang.String型を与えてください。
    ...
    /**
     * bundle[BlancoRestAutotest], key[XML2SOURCE_FILE.FIELD.TYPE]
     *
     * [項目の型 [{0}]] (ja)<br>
     *
     * @param arg0 置換文字列{0}を置換する値。java.lang.String型を与えてください。
    ...
    /**
     * bundle[BlancoRestAutotest], key[XML2SOURCE_FILE.FIELD.DEFAULT]
     *
     * [規定値   [{0}]] (ja)<br>
     *
     * @param arg0 置換文字列{0}を置換する値。java.lang.String型を与えてください。
    ...
    /**
     * bundle[BlancoRestAutotest], key[XML2SOURCE_FILE.SET.LANGDOC.01]
     *
    ...
    /**
     * bundle[BlancoRestAutotest], key[XML2SOURCE_FILE.SET.LANGDOC.02]
     *
     * [項目の型 [{0}]] (ja)<br>
     *
     * @param arg0 置換文字列{0}を置換する値。java.lang.String型を与えてください。
    ...
    /**
     * bundle[BlancoRestAutotest], key[XML2SOURCE_FILE.SET.ARG.LANGDOC]
     *
    ...
    /**
     * bundle[BlancoRestAutotest], key[XML2SOURCE_FILE.GET.LANGDOC.01]
     *
    ...
    /**
     * bundle[BlancoRestAutotest], key[XML2SOURCE_FILE.GET.LANGDOC.02]
     *
     * [項目の型 [{0}]] (ja)<br>
     *
     * @param arg0 置換文字列{0}を置換する値。java.lang.String型を与えてください。
    ...
    /**
     * bundle[BlancoRestAutotest], key[XML2SOURCE_FILE.GET.ARG.LANGDOC]
     *
     * [規定値   [{0}]] (ja)<br>
     *
     * @param arg0 置換文字列{0}を置換する値。java.lang.String型を与えてください。
    ...
    /**
     * bundle[BlancoRestAutotest], key[XML2SOURCE_FILE.GET.RETURN.LANGDOC]
     *
    ...
    /**
     * bundle[BlancoRestAutotest], key[XML2SOURCE_FILE.TYPE.LANGDOC.01]
     *
    ...
    /**
     * bundle[BlancoRestAutotest], key[XML2SOURCE_FILE.TYPE.LANGDOC.02]
     *
     * [項目の型 [{0}]] (ja)<br>
     *
     * @param arg0 置換文字列{0}を置換する値。java.lang.String型を与えてください。
    ...
    /**
     * bundle[BlancoRestAutotest], key[XML2SOURCE_FILE.TYPE.ARG.LANGDOC]
     *
     * [規定値   [{0}]] (ja)<br>
     *
     * @param arg0 置換文字列{0}を置換する値。java.lang.String型を与えてください。
    ...
    /**
     * bundle[BlancoRestAutotest], key[XML2SOURCE_FILE.TYPE.RETURN.LANGDOC]
     *
    ...
    /**
     * bundle[BlancoRestAutotest], key[ANTTASK.ERR001]
     *
    ...
    /**
     * bundle[BlancoRestAutotest], key[META2XML.ELEMENT_COMMON_CS]
     *
    ...
    /**
     * bundle[BlancoRestAutotest], key[META2XML.ELEMENT_COMMON_JS]
     *
    ...
    /**
     * bundle[BlancoRestAutotest], key[META2XML.ELEMENT_COMMON_VB]
     *
    ...
    /**
     * bundle[BlancoRestAutotest], key[META2XML.ELEMENT_COMMON_PHP]
     *
    ...
    /**
     * bundle[BlancoRestAutotest], key[META2XML.ELEMENT_COMMON_RUBY]
     *
    ...
    /**
     * bundle[BlancoRestAutotest], key[META2XML.ELEMENT_COMMON_PYTHON]
     *
    ...
    /**
     * bundle[BlancoRestAutotest], key[RUNTIME_ERROR_NOTNULL]
     *
     * [必須項目[ {0} ]がnullまたは未指定です。] (ja)<br>
     *
     * @param arg0 置換文字列{0}を置換する値。java.lang.String型を与えてください。
     * @return key[RUNTIME_ERROR_NOTNULL]に対応する値。外部から読み込みができない場合には、定義書の値を戻します。必ずnull以外の値が戻ります。
     */
    public String getRuntimeErrorNotnull(final String arg0) {
        // 初期値として定義書の値を利用します。
        String strFormat = "必須項目[ {0} ]がnullまたは未指定です。";
        try {
            if (fResourceBundle != null) {
                strFormat = fResourceBundle.getString("RUNTIME_ERROR_NOTNULL");
            }
        } catch (MissingResourceException ex) {
        }
        final MessageFormat messageFormat = new MessageFormat(strFormat);
    ...
    /**
     * bundle[BlancoRestAutotest], key[RUNTIME_ERROR_HTTPCODE]
     *
     * [HTTPエラーです。STAUS={0}] (ja)<br>
     *
     * @param arg0 置換文字列{0}を置換する値。java.lang.String型を与えてください。
     * @return key[RUNTIME_ERROR_HTTPCODE]に対応する値。外部から読み込みができない場合には、定義書の値を戻します。必ずnull以外の値が戻ります。
     */
    public String getRuntimeErrorHttpcode(final String arg0) {
        // 初期値として定義書の値を利用します。
        String strFormat = "HTTPエラーです。STAUS={0}";
        try {
            if (fResourceBundle != null) {
                strFormat = fResourceBundle.getString("RUNTIME_ERROR_HTTPCODE");
            }
        } catch (MissingResourceException ex) {
        }
        final MessageFormat messageFormat = new MessageFormat(strFormat);
